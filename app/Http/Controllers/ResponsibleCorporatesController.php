    ...
    public function create_responsible_corporate(Request $request)
    {
        if ($request->all()) {
            $data_l = [
                ...
                'total_energy_consumption_unit' => $this->encode_data($request->input('total_energy_consumption_unit', [])),
                'total_renewable_energy_consumption' => $this->encode_data($request->input('total_renewable_energy_consumption', [])),
                'total_renewable_energy_consumption_unit' => $this->encode_data($request->input('total_renewable_energy_consumption_unit', [])),
                'total_non_renewable_energy_consumption' => $this->encode_data($request->input('total_non_renewable_energy_consumption', [])),
                'total_non_renewable_energy_consumption_unit' => $this->encode_data($request->input('total_non_renewable_energy_consumption_unit', [])),
                'renewable_power_percentage' => $this->encode_data($request->input('renewable_power_percentage', [])),
                'renewable_power_percentage_unit' => $this->encode_data($request->input('renewable_power_percentage_unit', [])),
                'total_electricity_consumption' => $this->encode_data($request->input('total_electricity_consumption', [])),
                'total_electricity_consumption_unit' => $this->encode_data($request->input('total_electricity_consumption_unit', [])),
                'total_fuel_consumption' => $this->encode_data($request->input('total_fuel_consumption', [])),
                'total_fuel_consumption_unit' => $this->encode_data($request->input('total_fuel_consumption_unit', [])),
                'specific_energy_consumption' => $this->encode_data($request->input('specific_energy_consumption', [])),
                'specific_energy_consumption_unit' => $this->encode_data($request->input('specific_energy_consumption_unit', [])),
                'energy_intensity_per_rupee_turnover' => $this->encode_data($request->input('energy_intensity_per_rupee_turnover', [])),
                'energy_intensity_per_rupee_turnover_unit' => $this->encode_data($request->input('energy_intensity_per_rupee_turnover_unit', [])),
                ...
                'water_replenishment_percentage_unit' => $this->encode_data($request->input('water_replenishment_percentage_unit', [])),
                'total_water_withdrawal' => $this->encode_data($request->input('total_water_withdrawal', [])),
                'total_water_withdrawal_unit' => $this->encode_data($request->input('total_water_withdrawal_unit', [])),
                'total_water_withdrawal_by_source' => $this->encode_data($request->input('total_water_withdrawal_by_source', [])),
                'total_water_withdrawal_by_source_unit' => $this->encode_data($request->input('total_water_withdrawal_by_source_unit', [])),
                'total_water_consumption' => $this->encode_data($request->input('total_water_consumption', [])),
                'total_water_consumption_unit' => $this->encode_data($request->input('total_water_consumption_unit', [])),
                'total_water_discharged' => $this->encode_data($request->input('total_water_discharged', [])),
                'total_water_discharged_unit' => $this->encode_data($request->input('total_water_discharged_unit', [])),
                'water_intensity_per_rupee_turnover' => $this->encode_data($request->input('water_intensity_per_rupee_turnover', [])),
                'water_intensity_per_rupee_turnover_unit' => $this->encode_data($request->input('water_intensity_per_rupee_turnover_unit', [])),
                'specific_water_consumption' => $this->encode_data($request->input('specific_water_consumption', [])),
                'specific_water_consumption_unit' => $this->encode_data($request->input('specific_water_consumption_unit', [])),
                'waste_detail' => nl2br($request->input('waste_detail')),
                'hazardous_waste' => $this->encode_data($request->input('hazardous_waste', [])),
                'hazardous_waste_unit' => $this->encode_data($request->input('hazardous_waste_unit', [])),
                'non_hazardous_waste' => $this->encode_data($request->input('non_hazardous_waste', [])),
                'non_hazardous_waste_unit' => $this->encode_data($request->input('non_hazardous_waste_unit', [])),
                'waste_by_type' => $this->encode_data($request->input('waste_by_type', [])),
                'waste_by_type_unit' => $this->encode_data($request->input('waste_by_type_unit', [])),
                'waste_by_disposal_method' => $this->encode_data($request->input('waste_by_disposal_method', [])),
                'waste_by_disposal_method_unit' => $this->encode_data($request->input('waste_by_disposal_method_unit', [])),
                'waste_intensity_per_rupee_turnover' => $this->encode_data($request->input('waste_intensity_per_rupee_turnover', [])),
                'waste_intensity_per_rupee_turnover_unit' => $this->encode_data($request->input('waste_intensity_per_rupee_turnover_unit', [])),
                'waste_intensity_physical_output' => $this->encode_data($request->input('waste_intensity_physical_output', [])),
                'waste_intensity_physical_output_unit' => $this->encode_data($request->input('waste_intensity_physical_output_unit', [])),
                ...
                'scope_1_emissions_unit' => $this->encode_data($request->input('scope_1_emissions_unit', [])),
                'scope_2_emissions' => $this->encode_data($request->input('scope_2_emissions', [])),
                'scope_2_emissions_unit' => $this->encode_data($request->input('scope_2_emissions_unit', [])),
                'scope_3_emissions' => $this->encode_data($request->input('scope_3_emissions', [])),
                'scope_3_emissions_unit' => $this->encode_data($request->input('scope_3_emissions_unit', [])),
                'total_scope_1_2_emission_intensity' => $this->encode_data($request->input('total_scope_1_2_emission_intensity', [])),
                'total_scope_1_2_emission_intensity_unit' => $this->encode_data($request->input('total_scope_1_2_emission_intensity_unit', [])),
                ...
                'specific_emissions_scope_1_2_per_rupee_turnover_unit' => $this->encode_data($request->input('specific_emissions_scope_1_2_per_rupee_turnover_unit', [])),
                'air_pollutants' => $this->encode_data($request->input('air_pollutants', [])),
                'air_pollutants_unit' => $this->encode_data($request->input('air_pollutants_unit', [])),
                'hazardous_air_pollutants' => $this->encode_data($request->input('hazardous_air_pollutants', [])),
                'hazardous_air_pollutants_unit' => $this->encode_data($request->input('hazardous_air_pollutants_unit', [])),
